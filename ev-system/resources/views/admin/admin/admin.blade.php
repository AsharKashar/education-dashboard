    ...
    <div id="hide-table">
            <table id="example1" class="table table-striped table-bordered table-hover dataTable no-footer">
                ...
                <tr>
                    ...
                    <td data-title="{{ trans('others.admin_type') }}"> @if($post->admin_type == 'user') <button class="btn btn-primary btn-xs">User Admin</button> @elseif($post->admin_type == 'school') <button class="btn btn-warning btn-xs">School Admin</button> @elseif($post->admin_type == 'super') <button class="btn btn-danger btn-xs">Super Admin</button> @endif</td>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-9">
                                      <select class="form-control" name="admin_type">
                                          <option value="user" @if($post->admin_type == 'user') selected='selected' @endif>Admin</option>
                                          <option value="school" @if($post->admin_type == 'school') selected='selected' @endif>School Admin</option>
