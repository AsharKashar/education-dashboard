            ...
            <div class="row">
                  <div class="col-lg-12">
                      ...
                      <ul class="breadcrumb">
                          ...
                          <li class="active">Upload Bulk Exam Result</li>
                      </ul>
                      <!--breadcrumbs end -->
                  </div>
              </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                      ...
                      <section class="panel">
                          ...
                          <header class="panel-heading">
                          <a class="btn btn-primary" href="{{ url('ev-assets\uploads\sample-import\exam.csv') }}" style="margin:5px">
                                  Download Sample
                              </a>
                              </header>
                          ...
                          {!! Form::open(array('url'=>'exam/upload-bulk-exam','id'=>'demo-form2','class'=>'form-horizontal form-label-left' ,'role'=>'form','method'=>'POST', 'files'=>true)) !!}
                          <div class="col-lg-9">
