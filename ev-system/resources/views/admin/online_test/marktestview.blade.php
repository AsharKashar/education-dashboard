                        ...
                        <tbody>
                            @foreach( $questions as $key => $question )
                                ...
                                <tr>
                                    ...
                                    <td data-title="Point">
                                        <input type="text" name="point[]" value="{{ $question->point }}" class="form-control">
                                    </td>
                                    <td data-title="Action">
                                        <ul>
                                            <li>
                                                <label class="radio-inline">
                                                    <input type="radio"  name="action[{{$key}}][]" value="0" required> Correct
                                                </label>
                                            </li>
                                            <li>
                                                <label class="radio-inline">
                                                    <input type="radio" name="action[{{$key}}][]" value="1" required> Incorrect
                                                </label>
                                            </li>
                                        </ul>
                                    </td>
