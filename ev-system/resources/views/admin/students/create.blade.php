              ...
              <section class="panel">
                  ...
                  <div class="panel-body">
                    ...
                    <div class="col-lg-9">
                      ...
                      <div class="form-group">
                        <label  class="col-lg-2 control-label">{{ trans('student_lang.parent_guargian_name') }}/{{ trans('topbar_menu_lang.menu_parent') }}
                        </label>
                          <div class="col-lg-9">
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-lg-9">
                            <select class="form-control" name="school">
                              @foreach(App\School::get_schools() as $dt)
                      ...
                      <div class="form-group">
                        <label  class="col-lg-2 control-label">{{ trans('student_lang.student_photo') }}
                        </label>
                          <div class="col-lg-9">
