                                          ...
                                          <div class="tab-pane active" id="popular">
                                              <article class="media">
                                                  <div class="media-body">
                                                    ...
                                                    @endif
                                                        <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data" action="{{ url('purchase/check') }}">
                                                            ...
                                                            <div class="form-group">
                                                                <div class="row">
                                                                        ...
                                                                        <a href="{{ url('install') }}" class="btn btn-default pull-right">Previous Step</a>
                                                                    </div>
