  ...
  <div class="navbar-default sidebar" role="navigation">
    <div class="sidebar-nav navbar-collapse slimscrollsidebar">
      ...
      <ul class="nav" id="side-menu">
        ...
        @if(Auth::user()->permission('is_admin') && Auth::user()->admin_type == 'super'  && Auth::user()->admin_type != 'school')
        ...
        @if((Auth::user()->permission('is_admin') || Auth::user()->permission('is_teacher')) && Auth::user()->admin_type != 'school')
            <li class="waves-effect">
                    <a href="#">
                        <i class="fa fa-suitcase"></i> <span class="hide-menu">{{ trans('other.academics') }}<span class="fa arrow"></span></span>
                    </a>
                    <ul class="nav nav-second-level">
        ...
        @if(Auth::user()->permission('view_students'))
            <li class="waves-effect">
                <a href="#">
                    <i class="zmdi zmdi-male-female"></i> <span class="hide-menu">{{ trans('other.student') }}<span class="fa arrow"></span></span>
                </a>
                <ul class="nav nav-second-level">
        ...
        @endif
        @if(Auth::user()->permission('is_admin') || Auth::user()->role == 'teacher')
            {{-- <li class="waves-effect">
                <a href="#">
        ...
        @endif
        @if(Auth::user()->permission('is_admin') && Auth::user()->admin_type == 'super')
            <li class="waves-effect">
                <a href="#">
                    <i class="fa fa-building-o"></i> <span class="hide-menu"> {{ trans('other.schools') }}<span class="fa arrow"></span></span>
                </a>
                <ul class="nav nav-second-level">
        ...
        @endif
        @if(Auth::user()->permission('view_sections') && Auth::user()->admin_type != 'school')
             <li class="waves-effect">
            ...
            <li class="waves-effect">
                ...
                <ul class="nav nav-second-level">
                    @if(Auth::user()->admin_type == 'super')
                        <li><a href="{{ url('online_test') }}" class="waves-effect"><i class="fa fa-caret-right"></i> Main Tests Library</a></li>
                    @endif
                    <li><a href="{{ url('my-test-library') }}" class="waves-effect"><i class="fa fa-caret-right"></i> {{ trans('other.tests_library') }}</a></li>
                    <li><a href="{{ url('create-test') }}" class="waves-effect"><i class="fa fa-caret-right"></i>  {{ trans('other.add_test') }}</a></li>
                    <li><a href="{{ url('mark-test-question') }}" class="waves-effect"><i class="fa fa-caret-right"></i> {{ trans('other.mark_tests') }}</a></li>
                </ul>
            </li>
        @endif
        @if(Auth::user()->permission('view_subjects') && Auth::user()->admin_type != 'school')
            <li class="waves-effect">
                <a href="#">
                    <i class="fa fa-lightbulb-o"></i>
                    <span class="hide-menu">{{ trans('other.subject') }}<span class="fa arrow"></span> </span>
                </a>
                <ul class="nav nav-second-level">
                    @foreach( App\Classes::get_classes() as $classl )
        ...
        @if(Auth::user()->permission('is_student'))
            <li class="waves-effect">
                <a href="{{ url('student/subject/'.$authe->class_id) }}">
                    <i class="fa fa-lightbulb-o"></i>
                    <span class="hide-menu">{{ trans('other.subject') }} </span>
                </a>
            </li>
            <li class="waves-effect">
                <a href="javascript:;" >
            ...
            <li class="waves-effect">
                <a href="javascript:;" >
                    ...
                    <span class="hide-menu">{{ trans('other.mark_report_student') }} <span class="fa arrow"></span></span>
                </a>
                <ul class="nav nav-second-level">
            ...
            <li class="waves-effect">
                <a href="{{ url('student/class/study_material') }}" class="waves-effect">
                    ...
                    <span class="hide-menu">{{ trans('other.study_material') }}</span>
                </a>
            </li>
             {{-- <li class="waves-effect">
        ...
        @endif
        @if(Auth::user()->permission('is_admin') && Auth::user()->admin_type != 'school')
        {{-- <li class="waves-effect">
            <a href="javascript:;" >
        ...
        {{-- </li>  --}}
        @endif
        @if(Auth::user()->permission('view_exams') && Auth::user()->admin_type != 'school')
         {{-- <li class="waves-effect">
            <a href="javascript:;" >
        ...
        @endif
        @if(Auth::user()->permission('take_attendance') && Auth::user()->admin_type != 'school')
            {{-- <li class="waves-effect">
                <a href="javascript:;" >
                    <i class="fa fa-suitcase"></i>
        ...
        @if(Auth::user()->permission('view_tools') && Auth::user()->admin_type == 'super')
            <li class="waves-effect">
                <a href="javascript:;">
        ...
        @endif
        @if(Auth::user()->permission('view_settings') && Auth::user()->admin_type == 'super')
            <li class="waves-effect">
                <a href="javascript:;">
