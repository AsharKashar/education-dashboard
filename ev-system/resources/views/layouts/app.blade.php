...
<link rel="stylesheet" href="{{asset('ev-assets/backend/css/toastr.css')}}">
<!-- color CSS -->
...
<style>
  ...
  <?php 
    ...
    @endif
    <link href="{{ asset('ev-assets/backend/plugins/bower_components/datatables/custom.css') }}" rel="stylesheet">
...
<script type="text/javascript" language="javascript" src="{{ asset('ev-assets/backend/plugins/bower_components/datatables/datatables.min.js') }}"></script>
</head>
<body>
<div id="wrapper">
  <!-- Navigation -->
    ...
    <div class="navbar-header"> <a class="navbar-toggle hidden-sm hidden-md hidden-lg " href="javascript:void(0)" data-toggle="collapse" data-target=".navbar-collapse"><i class="ti-menu"></i></a>
      <div class="top-left-part">
        <a class="logo" href="<?php echo url('/dashboard'); ?>">
          ...
          <span class="hidden-xs">
            @if($get_school_admin && $get_school_admin->photo)<img src="{{ asset('ev-assets/uploads/school-images/'.$get_school_admin->photo) }}" alt="home" style="max-width: 180px;margin: 8px; max-height:45px"> @endif
          </span>
        </a>
      </div>
      ...
      <ul class="nav navbar-top-links navbar-right pull-right">
       ...
       {{-- <li class="dropdown"> <a class="dropdown-toggle waves-effect waves-light" data-toggle="dropdown" href="#">
          @if($messages->count() > 0) <span class="badge badge-new">{{$messages->count()}}</span> @endif
          <i class="icon-envelope" style="color:#222D32"></i>
          ...
          <ul class="dropdown-menu mailbox">
            ...
            @foreach($messages->take(5) as $countit )
            <li><!-- start message -->
        ...
        <img src="{{ asset('ev-assets/uploads/avatars/'.$authe->image) }}" alt="user-img" width="36" class="img-circle">
        @endif
        <b class="hidden-xs" style="color:#222D32">{{ Auth::user()->name }}</b> </a>
...
@yield('page-js')
<script src="{{asset('ev-assets/backend/plugins/bower_components/toastr/toastr.min.js')}}"></script>
<script src="{{asset('ev-assets/backend/js/toastr.script.js')}}"></script>
