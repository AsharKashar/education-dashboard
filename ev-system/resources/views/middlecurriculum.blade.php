      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread">Secondary Level Curriculum</h1>
            <p class="breadcrumbs"><span class="mr-2"><a href="{{asset('/')}}">Home <i class="ion-ios-arrow-forward"></i></a></span><span class="mr-2"><a href="{{asset('/curriculum')}}">Curriculum <i class="ion-ios-arrow-forward"></i></a></span> <span>Secondary Level Curriculum <i class="ion-ios-arrow-forward"></i></span></p>
          </div>
        </div>
      </div>
    </section>
        ...
        <div class="container">
          ...
          <div class="container" style="padding-bottom: 3em;">
                <div class="row">
                  <div class="col-lg"><center><h2 class=""><b>Secondary Level Curriculum</b></h2></center></div>
                </div>
                 <div class="row">
                        <div class="col-lg" style="padding-top:2em;padding-bottom:2em"><center><p style="color: rgba(0, 0, 0, 0.5);">Our curriculum includes projects and resources designed specifically for secondary level coders and coding educators with little or no coding experience. Our curriculum is based on popular block coding applications and tools where we gradually introduce a variety of practices and concepts while simultaneously introducing young coders to a variety of blocks and tools in Scratch. We have also introduced Robotics at this level.</p></center></div>
                      </div>
