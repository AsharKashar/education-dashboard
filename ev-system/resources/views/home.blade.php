...
<style type="text/css">.white-box .m-b-20{font-family: roboto, corbel, trebuchet ms}</style>
    ...
    <!-- .row -->
          ...
          <div class="row">
            ...
            <div class="col-lg-6 col-sm-6 col-xs-12">
              <div class="white-box white-box4">
                <h3 class="box-title">{{ trans('other.materials') }}</h3>
                <ul class="list-inline two-part">
            ...
            <div class="col-lg-6 col-sm-6 col-xs-12">
              <div class="white-box white-box2">
                <h3 class="box-title">{{ trans('other.active_tests') }}</h3>
                <ul class="list-inline two-part">
                  <li><i class="fa fa-edit text-danger"></i></li>
                  @php
                      $tst = App\Test::where('class_id', auth()->user()->class_id)->where('status',1)->get();
                  @endphp
                  <li class="text-right"><span class="counter ll">{{$tst->count()}}</span></li>
                </ul>
              </div>
            </div>
            <div class="col-lg-6 col-sm-6 col-xs-12">
              <div class="white-box white-box1">
                <h3 class="box-title">{{ trans('other.subjects') }}</h3>
                <ul class="list-inline two-part">
        ...
        <div class="col-md-4 col-lg-4 col-xs-12">
          ...
          <div class="white-box">
            <div class="user-bg">
              ...
              <img src="{{ asset('ev-assets/uploads/avatars/'.$authe->image) }}" alt="user" style="100%">
              @endif
              <div class="overlay-box">
                <div class="user-content"> <a href="javascript:void(0)">@if(auth()->user()->role != 'parent')<img alt="img" class="thumb-lg img-circle" src="{{ asset('ev-assets/uploads/avatars/'.$authe->image) }}">@endif</a>
                  <h4 class="text-white">{{ Auth::user()->name }}</h4>
                  <h5 class="text-white">{{ Auth::user()->email }}</h5>
                </div>
              </div>
      ...
      <div class="row">
        ...
        {{-- <div class="col-lg-6">
          ...
          {{-- Here Lied the code that was the hardest to find --}}
        ...
        <div class="col-lg-6 col-sm-12 col-xs-12 teller">
          ...
          <div class="row">
            <div class="col-lg-6 col-sm-6 col-xs-12">
              <div class="white-box white-box1">
                <h3 class="box-title">{{ trans('other.student') }}</h3>
                <ul class="list-inline two-part">
                  <li><i class="icon-graduation text-danger"></i></li>
                  <li class="text-right"><span class="counter ll">{{App\User::get_user('student')->count()}}</span></li>
                </ul>
              </div>
            </div>
            <div class="col-lg-6 col-sm-6 col-xs-12">
            ...
            <div class="col-lg-6 col-sm-6 col-xs-12">
              <div class="white-box white-box2">
                <h3 class="box-title">{{ trans('other.teacher') }}</h3>
                <ul class="list-inline two-part">
                  <li><i class="fa fa-group text-danger"></i></li>
                  <li class="text-right"><span class="counter ll">{{App\User::get_user('teacher')->count()}}</span></li>
                </ul>
              </div>
            </div>
            {{-- <div class="col-lg-6 col-sm-6 col-xs-12">
              <div class="white-box white-box1">
                ...
                <ul class="list-inline two-part">
                  <li><i class="fa fa-group text-danger"></i></li>
                  <li class="text-right"><span class="counter ll">{{App\User::get_user('parent')->count()}}</span></li>
                </ul>
              </div>
            </div> --}}
          </div>
  ...
  var CLASS_STAT = [<?php echo '"'.implode('","', $classStat).'"' ?>];
	...
	var barChartData = {
			labels: CLASSES,
			datasets: [{
				label: '{{ trans("other.absent") }}',
				backgroundColor: color("red").alpha(0.5).rgbString(),
				borderColor: "red",
				borderWidth: 1,
				data: ABS
			}, {
				label: '{{ trans("other.present") }}',
