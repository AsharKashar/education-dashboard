...
Route::get('/socialresponsible', function(){
    return view('socialresp');
});
...
Route::get('/technonlogy', function(){
    return view('technonlogy');
});
...
Route::get('/services/teachertraining', function(){
    return view('trainingteacher');
});

Route::get('/services/labsetup', function(){
    return view('labsetup');
});

Route::get('/services/studenttraining', function(){
    return view('studenttraining');
});

Route::get('/services/specializedCur', function(){
    return view('specializedCur');
});

Route::get('/services/technocamp', function(){
    return view('technocamp');
});
...
Route::get('/curriculum/elementcurriculum', function(){
    return view('elementcir');
});
Route::get('/curriculum/middlecurriculum', function(){
    return view('middlecurriculum');
});
Route::get('/curriculum/highcurriculum', function(){
    return view('highcurriculum');
});
...
Route::get('/user/view/{id}', 'HomeController@show_user_byid');
...
Route::get('my-test-library', 'HomeController@my_test_library');
Route::get('create-test', 'HomeController@create_test');
Route::get('edit-test/{id}','HomeController@edit_test');
Route::get('select-quiz-type/{slug}', 'HomeController@select_quiz_type');
...
Route::get('mark-test-question', 'HomeController@mark_test_question');
Route::post('mark-test-question', 'HomeController@mark_test_question');
Route::get('test/mark-test/{id}', 'HomeController@mark_test_view');
Route::post('mark-test-store', 'HomeController@mark_test_store');
Route::get('test/review-result/{id}', 'HomeController@review_test_result');
...
Route::get('create-lesson', 'HomeController@create_lesson');
Route::post('store-lesson', 'HomeController@store_lesson');
Route::get('edit-lesson/{id}','HomeController@edit_lesson');
Route::post('update-lesson','HomeController@update_lesson');
Route::get('lessons/delete/{id}', 'HomeController@destroy_lesson');
Route::get('select-lesson-quiz-type/{slug}', 'HomeController@select_lesson_quiz_type');


Route::get('send_sms', 'HomeController@send_sms');
Route::post('send_sms', 'HomeController@send_sms_now');
