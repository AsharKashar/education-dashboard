                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-9">
                                                    <select class="form-control" name="school">
                                                        <?php $__currentLoopData = App\School::get_schools(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $school): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          ...
                          <div id="hide-table">
                              <table id="example1" class="table table-striped table-bordered table-hover dataTable no-footer">
                                ...
                                <tr>
                                    ...
                                    <td data-title="<?php echo e(trans('others.school')); ?>"><?php echo e(App\School::find($class->school_id) ? App\School::find($class->school_id)->name :''); ?></td>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-lg-9">
                                                                <select class="form-control" name="school">
                                                                    <?php $__currentLoopData = App\School::get_schools(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $school): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <option value="<?php echo e($school->id); ?>" <?php if($class->school_id == $school->id): ?> selected <?php endif; ?>><?php echo e($school->name); ?></option>
                                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                </select>
                                                            </div>
                                                        </div>
