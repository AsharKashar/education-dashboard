        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active"><?php echo e(trans('other.online_test')); ?></li>
                </ul>
                <!--breadcrumbs end -->
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <section class="panel">
                    ...
                    <?php echo Form::open(array('url'=>'store_online_test','id'=>'quiz-form','class'=>'form-horizontal' ,'role'=>'form','method'=>'POST', 'files'=>true)); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-9">
                                        <select name="category" class="form-control" required>
                                            <option value="1"><?php echo e(trans('other.level1')); ?></option>
                                            <option value="2"><?php echo e(trans('other.level2')); ?></option>
                                            <option value="3"><?php echo e(trans('other.level3')); ?></option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-9">
                                        <select name="class_id" class="form-control" required  onchange="return get_class_subjects(this.value)">
                                            ...
                                            <?php $__currentLoopData = App\Classes::get_classes(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $classl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($classl->id); ?>"><?php echo e($classl->title); ?></option>
                            ...
                            <div class="col-md-6">
                                <div class="quiz-right">
                                    ...
                                    <div class="quiz-action-section">
                                        ...
                                        <button  type="submit" class="btn btn-success"><?php echo e(trans('other.submit_test_questions')); ?></button>
                                    </div>
                                </div>
