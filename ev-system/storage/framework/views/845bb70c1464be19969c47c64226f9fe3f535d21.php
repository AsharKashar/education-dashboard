                    ...
                    <table id="example1" class="table table-striped table-bordered table-hover dataTable no-footer"> 
                        <thead>
                            <tr>
                                ...
                                <th><?php echo e(trans('other.global')); ?></th>
                        ...
                        <tbody>
                            ...
                            <?php $__currentLoopData = $tests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $test): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td data-title="<?php echo e(trans('other.global')); ?>">
                                        <?php if($test->global == 1): ?><span class="badge badge-success"> <?php echo e(trans('other.yes')); ?> </span> <?php else: ?> <span class="badge badge-warning"> <?php echo e(trans('other.no')); ?> </span> <?php endif; ?>
                                    </td>
                                    <td data-title="<?php echo e(trans('other.category')); ?>"><?php echo e(trans('other.level')); ?>: <?php echo e($test->category); ?></td>
