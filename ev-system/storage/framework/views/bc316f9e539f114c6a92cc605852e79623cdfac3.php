...
<style type="text/css">.white-box .m-b-20{font-family: roboto, corbel, trebuchet ms}</style>
    ...
    <!-- .row -->
          ...
          <div class="row">
            ...
            <div class="col-lg-6 col-sm-6 col-xs-12">
              <div class="white-box white-box4">
                <h3 class="box-title"><?php echo e(trans('other.materials')); ?></h3>
                <ul class="list-inline two-part">
                  <li><i class="fa fa-file text-success"></i></li>
                  <li class="text-right"><span class="counter ll"><?php $count = App\Material::where('class_id', auth()->user()->class_id)->count(); echo $count;?></span></li>
                </ul>
              </div>
            </div>
            <div class="col-lg-6 col-sm-6 col-xs-12">
              <div class="white-box white-box2">
                <h3 class="box-title"><?php echo e(trans('other.active_tests')); ?></h3>
                <ul class="list-inline two-part">
                  <li><i class="fa fa-edit text-danger"></i></li>
                  <?php
                      $tst = App\Test::where('class_id', auth()->user()->class_id)->where('status',1)->get();
                  ?>
                  <li class="text-right"><span class="counter ll"><?php echo e($tst->count()); ?></span></li>
                </ul>
              </div>
            </div>
            <div class="col-lg-6 col-sm-6 col-xs-12">
              <div class="white-box white-box1">
                <h3 class="box-title"><?php echo e(trans('other.subjects')); ?></h3>
                <ul class="list-inline two-part">
                  <li><i class="fa fa-lightbulb-o text-danger"></i></li>
                  <li class="text-right"><span class="counter ll"><?php $count = App\Subject::where('class_id', auth()->user()->class_id)->count(); echo $count;?></span></li>
                </ul>
              </div>
            </div>
          </div>
      ...
      <div class="col-lg-8">
          ...
          <div class="white-box" style="padding-bottom:5px">
            <h3 class="box-title">Children Attendance Statss (<?php echo date('d').'-'.date('M').'-'.date('Y');?>)</h3>
            <ul class="basic-list">
              <?php 
        ...
        <div class="col-md-4 col-lg-4 col-xs-12">
          ...
          <div class="white-box">
            <div class="user-bg">
              ...
              <img src="<?php echo e(asset('ev-assets/uploads/avatars/'.$authe->image)); ?>" alt="user" style="100%">
              <?php endif; ?>
              <div class="overlay-box">
                <div class="user-content"> <a href="javascript:void(0)"><?php if(auth()->user()->role != 'parent'): ?><img alt="img" class="thumb-lg img-circle" src="<?php echo e(asset('ev-assets/uploads/avatars/'.$authe->image)); ?>"><?php endif; ?></a>
                  <h4 class="text-white"><?php echo e(Auth::user()->name); ?></h4>
                  <h5 class="text-white"><?php echo e(Auth::user()->email); ?></h5>
                </div>
              </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-6 col-sm-12 col-xs-12 teller">
          ...
          <div class="row">
            <div class="col-lg-6 col-sm-6 col-xs-12">
              <div class="white-box white-box1">
                <h3 class="box-title"><?php echo e(trans('other.student')); ?></h3>
                <ul class="list-inline two-part">
                  <li><i class="icon-graduation text-danger"></i></li>
                  <li class="text-right"><span class="counter ll"><?php echo e(App\User::get_user('student')->count()); ?></span></li>
                </ul>
              </div>
            </div>
            <div class="col-lg-6 col-sm-6 col-xs-12">
              <div class="white-box white-box4">
                ...
                <ul class="list-inline two-part">
                  <li><i class="fa fa-edit text-danger"></i></li>
                  <li class="text-right">
                    <span class="counter ll">
                      <?php
                          $getTests = \DB::table('tests')
                                      ->join('users', function($join){
                                        $join->on('users.id', '=', 'tests.user_id');
                                      })
                                      ->where('school_id', auth()->user()->school_id)
                                      ->where('status', 1)
                                      ->get();
                      ?>
                      <?php echo e($getTests->count()); ?>
            ...
            <div class="col-lg-6 col-sm-6 col-xs-12">
              <div class="white-box white-box2">
                <h3 class="box-title"><?php echo e(trans('other.teacher')); ?></h3>
                <ul class="list-inline two-part">
                  <li><i class="fa fa-group text-danger"></i></li>
                  <li class="text-right"><span class="counter ll"><?php echo e(App\User::get_user('teacher')->count()); ?></span></li>
                </ul>
              </div>
            </div>
  ...
  <?php 
    ...
    $presents = array();
    $classStat = array();
    $allclasses = App\Classes::get_class(10);
  ...
  var CLASS_STAT = [<?php echo '"'.implode('","', $classStat).'"' ?>];
	...
	var barChartData = {
			labels: CLASSES,
			datasets: [{
				label: '<?php echo e(trans("other.absent")); ?>',
				backgroundColor: color("red").alpha(0.5).rgbString(),
				borderColor: "red",
				borderWidth: 1,
				data: ABS
			}, {
				label: '<?php echo e(trans("other.present")); ?>',
  ...
  var barChartStat = {
			labels: CLASSES,
			datasets: [{
				label: '<?php echo e(trans("other.student")); ?>',
				backgroundColor: color('blue').alpha(0.5).rgbString(),
				borderColor: 'blue',
				borderWidth: 1,
				data: CLASS_STAT
