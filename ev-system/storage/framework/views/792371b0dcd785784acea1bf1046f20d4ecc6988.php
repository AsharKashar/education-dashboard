                        ...
                        <tbody>
                            <?php $__currentLoopData = $questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr>
                                    ...
                                    <td data-title="Point">
                                        <input type="text" name="point[]" value="<?php echo e(isset($mark_point[$key]) ? $mark_point[$key] : $question->point); ?>" class="form-control">
                                    </td>
                                    <td data-title="Action">
                                        <ul>
                                            <li>
                                                <label class="radio-inline">
                                                    <input type="radio" <?php if(isset($mark_action[$key]) && $mark_action[$key] == 0): ?> checked <?php endif; ?> name="action[<?php echo e($key); ?>][]" value="0" required> Correct
                                                </label>
                                            </li>
                                            <li>
                                                <label class="radio-inline">
                                                    <input type="radio" <?php if(isset($mark_action[$key]) && $mark_action[$key] == 1): ?> checked <?php endif; ?> name="action[<?php echo e($key); ?>][]" value="1" required> Incorrect
                                                </label>
                                            </li>
                                        </ul>
                                    </td>
